...
ThrusterWindow1::ThrusterWindow1(QWidget *parent) :
        QWidget(parent) {
    setupUi(this);
...
void ThrusterWindow1::updateVehicle() {
    currentVehicle = settings->value("currentVehicle").toString();
    thrustersCount = settings->value("vehicle/" +
                                     currentVehicle +
                                     "/thrusters/count").toInt();
...
void ThrusterWindow1::updateThrusterSettings() {
    idSpinBox->setValue(
            settings->value("vehicle/" +
                            currentVehicle +
                            "/thrusters/" +
    ...
    verticalSliderBackwardK->setValue(static_cast<int>(
                                              settings->value("vehicle/" +
                                                              ...
                                                              QString::number(currentThruster) +
                                                              "/backwardK").toDouble() *
                                              verticalSliderBackwardK->maximum()));
...
void ThrusterWindow1::thrusterButtonClicked(int value) {
...
void ThrusterWindow1::thrusterIdChanged(int value) {
...
void ThrusterWindow1::thrusterReverseChanged(int state) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
    data.reverse = state;
    uv_interface.setThrusterData(currentThruster, data);
...
void ThrusterWindow1::flashButtonClicked() {
    // Signal for the Serial_Server to set flash flag
    emit flashVehicle();
}

void ThrusterWindow1::sliderVelocityChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
    data.velocity = value;
    uv_interface.setThrusterData(currentThruster, data);
...
void ThrusterWindow1::sliderKForwardChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
    data.kForward = value;
    uv_interface.setThrusterData(currentThruster, data);
...
void ThrusterWindow1::sliderKBackwardChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
...
void ThrusterWindow1::sliderForwardSaturationChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
    data.sForward = value;
    uv_interface.setThrusterData(currentThruster, data);
...
void ThrusterWindow1::sliderBackwardSaturationChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
...
void ThrusterWindow1::spinBoxVelocityChanged(int value) {
    // Secure updating UVState structure
    UV_Thruster data = uv_interface.getThrusterData(currentThruster);
    data.velocity = value;
    uv_interface.setThrusterData(currentThruster, data);
...
void ThrusterWindow1::spinBoxKForwardChanged(double value) {
...
void ThrusterWindow1::spinBoxKBackwardChanged(double value) {
...
void ThrusterWindow1::spinBoxForwardSaturationChanged(int value) {
    // Updating QSettings
    settings->setValue("vehicle/" +
                       currentVehicle +
                       "/thrusters/" +
...
void ThrusterWindow1::spinBoxBackwardSaturationChanged(int value) {
    // Updating QSettings
    settings->setValue("vehicle/" +
                       currentVehicle +
                       "/thrusters/" +
